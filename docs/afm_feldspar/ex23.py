"""
Generate AFM probe mesh using Capsol (FD) nodal points with 98 nm tip-sample
separation.
"""
...
inpargs = {'n': 500, 'm': 500, 'l_js': 500,
           ...
           'reps_s': 5.0, 'Hsam': 1e6,
           'reps_w': 1.0, 'Hwat': 2.0,  # equivalent to air
           'd': 98.0}  # tip-sample separation in use
capsol = CapSolData(**inpargs)
mesh_prefix = 'docs/afm_feldspar/meshes/mesh_ex23'
